...
def main(args):
    ...
    while t < cfg.train.max_iter:
        ...
        for i, batch in enumerate(train_loader):
            ...
            entropy_loss = -args.entropy_weight * entropy_criterion(dynamic_atts[:, :-1, :], masks[:, 1:])
                ...
                with torch.no_grad():
                    ...
                    for val_i, val_batch in enumerate(val_loader):
                        ...
                        img_1_feature, img_2_feature, labels, masks, \
                            img_1_path, img_2_path = val_batch
                        ...
                        del img_1_feature, img_2_feature, chg_pos_logits, masks
                        gc.collect()
                        ...
                        gts = decode_sequence(idx_to_word, labels)
                        gen_sent_length = labels.size(1)
