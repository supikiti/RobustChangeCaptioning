...
parser.add_argument("--img_cap_pair_file_path", type = str, default = "data/img_cap_pair.txt")
...
def split_cap_data(data_list):
    ...
    train_list, dev_list, eval_list = np.split(data_list, idxs)
    print(len(train_list), len(dev_list), len(eval_list))
    exit()
