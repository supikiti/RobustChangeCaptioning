...
class HAGDataset_with_rcnn(Dataset):
    ...
    def __getitem__(self, i):
        ...
        idx, img_1_img_path, img_2_img_path, cap_data, info_path_1, \
            info_path_2 = self.split_data[i]
        ...
        # load pair info containing bounding box, class, and scene graph
        info_data_1 = load_pickle_data(info_path_1)
        info_data_2 = load_pickle_data(info_path_1)
